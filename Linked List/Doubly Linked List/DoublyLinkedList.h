...
class DoublyLinkedList {
	...
	public:
		...
		void uni(DoublyLinkedList a, DoublyLinkedList b);

		// Does the set intersection operation
		void intersec(DoublyLinkedList a, DoublyLinkedList b);

		// Does the set difference operation
		void diff(DoublyLinkedList a, DoublyLinkedList b);

		// Does the subset of a set operation
		bool contained(DoublyLinkedList a, DoublyLinkedList b);
};