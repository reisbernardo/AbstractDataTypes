...
class CircularLinkedList {
	...
	public:
		...
		void uni(CircularLinkedList a, CircularLinkedList b);

		// Does the set intersection operation
		void intersec(CircularLinkedList a, CircularLinkedList b);

		// Does the set difference operation
		void diff(CircularLinkedList a, CircularLinkedList b);

		// Does the subset of a set operation
		bool contained(CircularLinkedList a, CircularLinkedList b);
};